...
class ExpandableBottomSheet extends StatefulWidget {
  ...
  const ExpandableBottomSheet(
      {super.key, required this.productModel, required this.userId});
...
class _ExpandableBottomSheetState extends State<ExpandableBottomSheet>
  ...
  void initState() {
    super.initState();
    _price = formatDiscountedPriceToInt(widget.productModel.price,
              ...
              children: [
                Expanded(
                  ...
                  child: OutlinedButton(
                    onPressed: () {
                      context.read<ProductCartBloc>().add(AddToCartEvent(
                          widget.productModel,
                          quantity: _quantity));
                    },
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      final orderItem = OrderItemModel(
                          ...
                          productImageUrl:
                              widget.productModel.productImageList[0],
